...
> ✅ **NexHub 基础功能已完成**：四合一聚合、源即插件、Bangumi 同步、网络配置、收藏分组评论、阅读统计、调试崩溃日志等核心能力均已就绪。**后续版本以修复 bug 与功能进阶为主，从本版起可放心升级**。无破坏性数据变更，可直接覆盖安装。详见下方《更新日志（v0.5.0 → v0.5.1）》。
...
本版相对 v0.5.0 共 2 个提交，重点是**源管理与收藏流程重构**，一批**源能力增强**（库源一键更新 / 源置顶 / 镜像测速 / 镜像自动获取 / 评论兼容 / 脚本文本预取），以及若干崩溃修复与体验优化。
