...
这是 NexHub 的 **0.4.x 预览版**。NexHub **不内置任何内容源**，所有内容都来自你自行导入的「源」。

> ⚠️ **v0.5.0 是 v0.4.5 的功能增量版（minor）**（全新阅读统计页、调试 / 崩溃日志、设置页重构、播放器设置打通全局 + 剧集覆盖）。**仍属 0.x 预览版，Bug 数量可能高于稳定版**。追求稳定请留在 v0.3.1，愿意试用请先备份数据。详见下方《更新日志（v0.4.5 → v0.5.0）》。
...
- **0.4.x 为预览版**：部分高级功能仍在完善中，欢迎通过 Issue / 社区反馈问题。
