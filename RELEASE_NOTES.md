...
> ⚠️ **v0.4.1 是 v0.4.0 的跟进预览版**（修复 v0.4.0 海外 CI 构建失败、强化 Bangumi 同步与源管理、一批阅读器 / 漫画 / 暗色模式修复）。**仍属 0.4.x 预览版，Bug 数量可能高于稳定版**。追求稳定请留在 v0.3.1，愿意试用请先备份数据。详见下方《更新日志（v0.4.0 → v0.4.1）》。
