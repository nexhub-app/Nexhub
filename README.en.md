...
> Latest release: **v2.0.3 (stable)**. The previous release is **v2.0.2** (stable). The project is under continuous development. Contributions and ideas are welcome via Pull Requests / issues. See [RELEASE_NOTES](./RELEASE_NOTES.md) for the full changelog.
